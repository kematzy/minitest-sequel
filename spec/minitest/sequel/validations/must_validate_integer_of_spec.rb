...
describe Minitest::Expectations do
  describe '#must_validate_integer_of(:attribute, :opts, :msg)' do
    before do
    ...
    describe 'should NOT raise an error' do
      it 'when correctly validating the presence of Post#title' do
        assert_no_error { _(@m).must_validate_integer_of(:id) }
      end
    end
    ...
    describe 'should raise an error' do
      it 'when validating a valid provided options' do
        ...
        assert_error_raised(msg) do
          _(@m).must_validate_integer_of(:id, { message: 'dummy' })
        end
      end
      ...
      describe 'when validating an incorrect provided option' do
        it ':message' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_integer_of(:id, { message: 'dummy' }) }
        end
        ...
        %i[nil_message too_long too_short wrong_length].each do |t|
          it ":#{t}" do
            ...
            assert_error_raised(msg) do
              _(@m).must_validate_integer_of(:id, { t.to_sym => 'dummy' })
            end
          end
        end
        ...
        it ':is' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_integer_of(:id, { is: 10 }) }
        end
        ...
        it ':minimum' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_integer_of(:id, { minimum: 10 }) }
        end
        ...
        it ':maximum' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_integer_of(:id, { maximum: 20 }) }
        end
        ...
        it ':within' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_integer_of(:id, { within: 10..20 }) }
        end
      end
      ...
      it 'when the attribute is not being validated' do
        ...
        assert_error_raised(msg) { _(@m).must_validate_integer_of(:title) }
      end
      ...
      it 'when the attribute is not present' do
        ...
        assert_error_raised(msg) do
          _(@m).must_validate_integer_of(:does_not_exist)
        end
      end
    end
    # /should raise an error
  end
  # /#must_validate_integer_of(:attribute, :opts, :msg)
end
