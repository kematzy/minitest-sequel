...
describe Minitest::Expectations do
  describe '#must_validate_length_of(:attribute, :opts, :msg)' do
    before do
    ...
    describe 'should NOT raise an error' do
      it 'when correctly validating the length of Post#title' do
        assert_no_error { _(@m).must_validate_length_of(:title) }
      end
    end
    ...
    describe 'should raise an error' do
      describe 'when validating an incorrect provided option' do
        it ':message' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_length_of(:title, { message: 'dummy' }) }
        end
        ...
        it ':nil_message' do
          ...
          assert_error_raised(msg) do
            _(@m).must_validate_length_of(:title, { nil_message: 'dummy' })
          end
        end
        ...
        it ':too_long' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_length_of(:title, { too_long: 'dummy' }) }
        end
        ...
        it ':too_short' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_length_of(:title, { too_short: 'dummy' }) }
        end
        ...
        it ':wrong_length' do
          ...
          assert_error_raised(msg) do
            _(@m).must_validate_length_of(:title, { wrong_length: 'dummy' })
          end
        end
        ...
        it ':is' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_length_of(:title, { is: 10 }) }
        end
        ...
        it ':minimum' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_length_of(:title, { minimum: 10 }) }
        end
        ...
        it ':maximum' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_length_of(:title, { maximum: 20 }) }
        end
        ...
        it ':within' do
          ...
          assert_error_raised(msg) { _(@m).must_validate_length_of(:title, { within: 10..20 }) }
        end
      end
      ...
      it 'when the attribute is not being validated' do
        ...
        assert_error_raised(msg) { _(@m).must_validate_length_of(:author_id) }
      end
      ...
      it 'when the attribute is not present' do
        ...
        assert_error_raised(msg) do
          _(@m).must_validate_length_of(:does_not_exist, 10)
        end
      end
    end
    # /should raise an error
  end
  # /#must_validate_length_of(:attribute, :opts, :msg)
end
