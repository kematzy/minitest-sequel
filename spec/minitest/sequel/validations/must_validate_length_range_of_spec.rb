...
describe Minitest::Expectations do
  describe '#must_validate_length_range_of(:attribute, :opts, :msg)' do
    before do
    ...
    describe 'should NOT raise an error' do
      it 'when correctly validating the exact length of Post#title' do
        assert_no_error { _(@m).must_validate_length_range_of(:title, 10..20) }

        assert_no_error { _(@m).must_validate_length_of(:title, { within: 10..20 }) }
      end
    end
    ...
    describe 'should raise an error' do
      describe 'when validating an incorrect provided option' do
        it ':message' do
          ...
          assert_error_raised(msg) do
            _(@m).must_validate_length_range_of(:title, 10..20, { message: 'dummy' })
          end
        end
        ...
        it ':nil_message' do
          ...
          assert_error_raised(msg) do
            _(@m).must_validate_length_range_of(:title, 10..20, { nil_message: 'dummy' })
          end
        end
        ...
        it ':too_long' do
          ...
          assert_error_raised(msg) do
            _(@m).must_validate_length_range_of(:title, 10..20, { too_long: 'dummy' })
          end
        end
        ...
        it ':too_short' do
          ...
          assert_error_raised(msg) do
            _(@m).must_validate_length_range_of(:title, 10..20, { too_short: 'dummy' })
          end
        end
        ...
        it ':wrong_length' do
          ...
          assert_error_raised(msg) do
            _(@m).must_validate_length_range_of(:title, 10..20, { wrong_length: 'dummy' })
          end
        end
        ...
        it ':is' do
          ...
          assert_error_raised(msg) do
            _(@m).must_validate_length_range_of(:title, 10..20, { is: 10 })
          end
        end
        ...
        it ':minimum' do
          ...
          assert_error_raised(msg) do
            _(@m).must_validate_length_range_of(:title, 10..20, { minimum: 10 })
          end
        end
        ...
        it ':maximum' do
          ...
          assert_error_raised(msg) do
            _(@m).must_validate_length_range_of(:title, 10..20, { maximum: 20 })
          end
        end

        it ':within' do
          # rubocop:disable Layout/LineLength
          msg = /Expected .* to validate :length for :title column with: { within: '20..30' } but found: { within: '10..20' }/
          # rubocop:enable Layout/LineLength

          assert_error_raised(msg) do
            _(@m).must_validate_length_range_of(:title, 20..30, { within: 30..40 })
          end
        end
      end
      ...
      it 'when the attribute is not being validated' do
        ...
        assert_error_raised(msg) do
          _(@m).must_validate_length_range_of(:author_id, 10..20)
        end
      end
      ...
      it 'when the attribute is not present' do
        ...
        assert_error_raised(msg) do
          _(@m).must_validate_length_range_of(:does_not_exist, 10..20)
        end
      end
    end
    # /should raise an error
  end
  # /#must_validate_length_range_of(:attribute, :opts, :msg)
end
