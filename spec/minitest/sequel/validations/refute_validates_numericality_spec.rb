...
describe Minitest::Assertions do
  describe '#refute_validates_numericality(:model, :attribute, :opts, :msg)' do
    before do
    ...
    describe 'should NOT raise an error' do
      it 'when column is NOT validated' do
        assert_no_error { refute_validates_numericality(@m, :author_id) }
      end
    end
    ...
    describe 'should raise an error' do
      it 'when column is validated' do
        ...
        assert_error_raised(msg) { refute_validates_numericality(@m, :id) }
      end

      it 'when trying to validate invalid column' do
        msg = /Column :does_not_exist is not defined in .*/

        assert_error_raised(msg) { refute_validates_numericality(@m, :does_not_exist) }
      end
  ...
  # /#refute_validates_numericality(:model, :attribute, :opts, :msg)
end
