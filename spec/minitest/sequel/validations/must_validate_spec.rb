...
describe Minitest::Expectations do
  describe '#must_validate(:validation_type, :attribute, :opts, :msg)' do
    before do
    ...
    describe 'should NOT raise an error' do
      it 'when correctly validating Post#title' do
        assert_no_error { _(@m).must_validate(:presence, :title) }
      end
    end
    ...
    describe 'should raise an error' do
      it 'when trying to validate invalid column' do
        ...
        assert_error_raised(msg) { _(@m).must_validate(:presence, :does_not_exist) }
      end
      ...
      it 'when validating incorrect provided options' do
        ...
        assert_error_raised(msg) { _(@m).must_validate(:presence, :title, { message: 'dummy' }) }
      end
      ...
      it 'when the attribute is not being validated' do
        ...
        assert_error_raised(msg) { _(@m).must_validate(:presence, :author_id) }
      end
      ...
      it 'when invalid option(s) are passed' do
        ...
        assert_error_raised(msg) do
          _(@m).must_validate(:presence, :title, { completey_invalid: false })
        end
      end
      ...
      it 'when the validation type is wrong for the column' do
        ...
        assert_error_raised(msg) do
          _(@m).must_validate(:numericality, :title)
        end
      end
      ...
      it 'when the attribute is not present' do
        ...
        assert_error_raised(msg) do
          _(@m).must_validate(:presence, :does_not_exist)
        end
      end
    end
    # /should raise an error
  end
  # /#must_validate(:validation_type, :attribute, :opts, :msg)
end
