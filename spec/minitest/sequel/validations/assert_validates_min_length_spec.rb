...
describe Minitest::Assertions do
  describe '#assert_validates_min_length(:model, :attribute, :opts, :msg)' do
    before do
    ...
    describe 'should NOT raise an error' do
      it 'when correctly validating the exact length of #title' do
        assert_no_error { assert_validates_min_length(@m, :title, 10) }

        assert_no_error { assert_validates_length(@m, :title, { minimum: 10 }) }
      end
    end
    ...
    describe 'should raise an error' do
      describe 'when validating an incorrect provided option' do
        it ':message' do
          ...
          assert_error_raised(msg) do
            assert_validates_min_length(@m, :title, 10, { message: 'dummy' })
          end
        end
        ...
        it ':nil_message' do
          ...
          assert_error_raised(msg) do
            assert_validates_min_length(@m, :title, 10, { nil_message: 'dummy' })
          end
        end
        ...
        it ':too_long' do
          ...
          assert_error_raised(msg) do
            assert_validates_min_length(@m, :title, 10, { too_long: 'dummy' })
          end
        end
        ...
        it ':too_short' do
          ...
          assert_error_raised(msg) do
            assert_validates_min_length(@m, :title, 10, { too_short: 'dummy' })
          end
        end
        ...
        it ':wrong_length' do
          ...
          assert_error_raised(msg) do
            assert_validates_min_length(@m, :title, 10, { wrong_length: 'dummy' })
          end
        end
        ...
        it ':minimum' do
          ...
          assert_error_raised(msg) do
            assert_validates_min_length(@m, :title, 15, { minimum: 10 })
          end
        end
        ...
        it ':is' do
          ...
          assert_error_raised(msg) do
            assert_validates_min_length(@m, :title, 10, { is: 20 })
          end
        end
        ...
        it ':maximum' do
          ...
          assert_error_raised(msg) do
            assert_validates_min_length(@m, :title, 10, { maximum: 20 })
          end
        end
        ...
        it ':within' do
          ...
          assert_error_raised(msg) do
            assert_validates_min_length(@m, :title, 10, { within: 10..20 })
          end
        end
      end
      ...
      it 'when the attribute is not being validated' do
        ...
        assert_error_raised(msg) { assert_validates_min_length(@m, :author_id, 10) }
      end
      ...
      it 'when the attribute is not present' do
        ...
        assert_error_raised(msg) do
          assert_validates_min_length(@m, :does_not_exist, 10)
        end
      end
    end
    # /should raise an error
  end
  # /#assert_validates_min_length(:model, :attribute, :opts, :msg)
end
